...
<div id="tw">
	...
	<textarea class="input-01"  id="rtext_<?php echo $tid; ?>"></textarea>
    <div class="tbutton">
        ...
        <input class="btn pagenavi-btn pagenavi-info-btn" type="button" onclick="reply('<?php echo DYNAMIC_BLOGURL; ?>index.php?action=reply',<?php echo $tid;?>);" value="回复" /> 
