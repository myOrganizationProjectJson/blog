...
<div class="login-main">
	...
	<div class="login-logo"><a href="http://www.verytalk.cn" target="_blank" style='font-size: 30px;
    /* text-align: center; */
    color: #09C;
    text-decoration: none;
    padding: 78px;
}'>VeryTalk<!--  img src="./views/images/login_logo.png" alt="emlog" width="294" height="68" />--></a></div>
	...
	<div class="back"><a href="http://blog.verytalk.cn">&laquo;返回首页</a> <!--  | <!-- a href="http://wiki.emlog.net/doku.php?id=chpwd" target="_blank">忘记密码?</a> --></div>
</div>
<?php if ($error_msg): ?>
